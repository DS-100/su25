...
|  |  |  |  | <span style="color:#c91d1d">Homework or Project Released</span> |
| <span style="color:#c91d1d">Lab</span>  |  |  | <span style="color:#c91d1d">Lab</span> |  |
...
- We will not be having lab sections for Data 100 this semester. Rather, we'll provide extensive lab support on Ed and accompanying video walkthroughs. (TBA)
